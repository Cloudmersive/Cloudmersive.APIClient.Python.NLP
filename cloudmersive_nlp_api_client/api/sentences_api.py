...
class SentencesApi(object):
    ...
    def sentences_post(self, input, **kwargs):  # noqa: E501
        ...
        >>> thread = api.sentences_post(input, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.sentences_post_with_http_info(input, **kwargs)  # noqa: E501
        else:
            (data) = self.sentences_post_with_http_info(input, **kwargs)  # noqa: E501
            return data

    def sentences_post_with_http_info(self, input, **kwargs):  # noqa: E501
        """Extract sentences from string  # noqa: E501

        Segment an input string into separate sentences, output result as a string.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sentences_post_with_http_info(input, async_req=True)
        >>> result = thread.get()
        ...
        if ('input' not in params or
            ...
            raise ValueError("Missing the required parameter `input` when calling `sentences_post`")  # noqa: E501
